...
c
      allocate(ptlm(0:ldegmax,6,0:ndmax),stat=ierr)
      if(ierr.ne.0)stop ' Error in qpgetinp: ptlm not allocated!'
c
...
c
      ...
      strainrateout(1)=outfile(1:flen)//'_strn_rate_ee.dat'
      strainrateout(2)=outfile(1:flen)//'_strn_rate_en.dat'
      strainrateout(3)=outfile(1:flen)//'_strrate_ez.dat'
      strainrateout(4)=outfile(1:flen)//'_strn_rate_nn.dat'
      strainrateout(5)=outfile(1:flen)//'_strn_rate_nz.dat'
      strainrateout(6)=outfile(1:flen)//'_strn_rate_zz.dat'
c
      ...
      stressrateout(1)=outfile(1:flen)//'_strs_rate_ee.dat'
      stressrateout(2)=outfile(1:flen)//'_strs_rate_en.dat'
      stressrateout(3)=outfile(1:flen)//'_strs_rate_ez.dat'
      stressrateout(4)=outfile(1:flen)//'_strs_rate_nn.dat'
      stressrateout(5)=outfile(1:flen)//'_strs_rate_nz.dat'
      stressrateout(6)=outfile(1:flen)//'_strs_rate_zz.dat'
c
      gravout(1)=outfile(1:flen)//'_grav_acce_e.dat'
      gravout(2)=outfile(1:flen)//'_grav_acce_n.dat'
      gravout(3)=outfile(1:flen)//'_grav_acce_z.dat'
c
      grpotout=outfile(1:flen)//'_grav_pote.dat'
c
