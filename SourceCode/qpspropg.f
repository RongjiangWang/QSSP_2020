...
c
      ...
      complex*16 cdet,alf,cxi,bet,cyabs,cyswap,ca,cb,cros
      complex*16 c11,c12,ck2,cn2,cvp2rr
...
c
      sety0up=.false.
c
c     start of downward propagation
c
...
c
     ...
     &         *dcmplx(dsin(0.5d0*PI*f/fbvatm)**3,0.d0)
          endif
...
c
c         interface ocean bottom to atmosphere
c
...
c
      do ly=max0(lyup,lycm),min0(lycc,lys)-1
        if(lyr.eq.ly)then
          do j=1,3
            do i=1,6
              y0(i,j)=(0.d0,0.d0)
...
c        yup(5,j)=yup(5,j)
      ...
      enddo
c
c     end of downward propagation
c===============================================================================
c     start of upward propagation
c
      sety0lw=.false.
c
