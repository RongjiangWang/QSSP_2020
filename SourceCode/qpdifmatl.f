...
c
      real*8 f,f1,f2,mass,rorr,alfa,beta,dro,ro1,n2up,n2lw
...
c
        ...
        if(n2up.lt.0.d0.or.n2lw.lt.0.d0.or.ly.ge.lycm)then
          cn2rr=(0.d0,0.d0)
        else if(f.le.fbvatm)then
          cn2rr=cn2rr*dcmplx(dsin(0.5d0*PI*f/fbvatm)**3,0.d0)
        endif
      endif
c
